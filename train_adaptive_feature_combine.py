...
def process(ptemplate, fold_number, fold_testing, fold_training, file_prefix):
    ...
    with open('/data/hdj/tracking_buggy_files/featureMerge/all_results_df_before_1017.pickle', 'wb') as file:
    ...
    with open('/data/hdj/tracking_buggy_files/featureMerge/all_results_df_after_1017.pickle', 'wb') as file:
        pickle.dump(all_results_df, file, protocol=pickle.HIGHEST_PROTOCOL)
