...
def load_data_folds(file_prefix):
    ...
    for k in range(fold_number + 1):
        ...
        # fold_training[k] = pd.read_pickle(file_prefix + '_normalized_training_fold_' + str(k) + '_tar1018')
        # fold_testing[k] = pd.read_pickle(file_prefix + '_normalized_testing_fold_' + str(k) + '_tar1018')
        ...
        # fold_testing[k] = pd.read_pickle(file_prefix + '_normalized_testing_fold_' + str(k)+'_adddata1016')
